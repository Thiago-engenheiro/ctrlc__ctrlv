    ...
    <>
      <section className="PublicacaoCodigoV2">
        <a className="LinkPublicacao" href="teste">
          ...
          <div className="continericonePubliacao codigo">
            <img
          ...
          <div className="continerPublicacaoMaior">
            <div className="continerImagemPublicacaoMaior">
              <img
                ...
                src="/imagens/publicacao/codigo/botoes.animado.gif"
                alt="imagem"
              ></img>
              <p className="ContinerTaggPublicacao codigo">
                Codigo
                <img
          ...
          <div className="continerPublicacaoMenor">
            <div className="continerPublicacaoMenorPostagem comBorda">
              <div className="continerImagemPublicacaoMenor">
                <img
                  className="PubliacaoImagem"
                  src="/imagens/publicacao/codigo/cards-animat.gif"
                  alt="imagem"
                ></img>
                <p className="ContinerTaggPublicacao codigo">
                  Codigo
              ...
              <h5 className="continerPublicacoesTituloMenor">
                Cards: 15 Opções gratuitas de modelos de cards que que uso no
                dia dia
              </h5>

              <p className="continerPublicacoesTextoMenor">
                Seja para destacar informações, produtos ou conteúdos visuais,
                os cards são essenciais em interfaces modernas. Neste post,
                reuni 15 designs de cards encontrados pela web que são
                funcionais e cheios de estilo para inspirar seus projetos!
              </p>
            </div>
            ...
            <div className="continerPublicacaoMenorPostagem">
              <div className="continerImagemPublicacaoMenor">
                <img
                  className="PubliacaoImagem"
                  src="/imagens/publicacao/codigo/carregaemnto.animado.gif"
                  alt="imagem"
                ></img>
                <p className="ContinerTaggPublicacao codigo">
                  Codigo
              ...
              <h5 className="continerPublicacoesTituloMenor">
                Animações de Carregamento: 12 Modelos Criativos que Encontrei na
                Web
              </h5>

              <p className="continerPublicacoesTextoMenor">
                As animações de carregamento são essenciais para manter os
                usuários engajados enquanto esperam. Confira 12 modelos
                criativos, como círculos giratórios, barras animadas e outros
                designs inteligentes, que podem dar um toque especial aos seus
                projetos!
              </p>
            </div>
          </div>
